<?php 
      ...
      // Get total count
      $total_query = mysqli_query($connect, "SELECT COUNT(*) as total FROM ec_categories");
      $total_row = mysqli_fetch_assoc($total_query);
      $total_items = $total_row['total'];
      $total_pages = ceil($total_items / $items_per_page);
      
      // Get paginated categories
      $sql = "SELECT * FROM ec_categories ORDER BY cate_name ASC LIMIT $items_per_page OFFSET $offset";
               ...
               <div class="white_card_header">
                  <div class="box_header m-0">
                     <div class="main-title">
                        <h3 class="m-0">Category Table (Total: <?php echo $total_items; ?>)</h3>
                     </div>
                  </div>
               </div>
